...
using Bestwise.WJCourt.Persons.Authorization;
using Bestwise.WJCourt.Persons.Dtos;
using Bestwise.WJCourt.Persons.DomainServices;
...
namespace Bestwise.WJCourt.Persons
{
    ...
    public class PersonAppService : WJCourtAppServiceBase, IPersonAppService
    {

...
namespace Bestwise.WJCourt.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        private readonly WJCourtDbContext _context;

        public HostRoleAndUserCreator(WJCourtDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new WJCourtAuthorizationProvider())
